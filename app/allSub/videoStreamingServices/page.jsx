...
const page = () => {
  const videoStreamingServices = Object.values(data).filter(
    (entry) => entry.category === "videoStreamingServices"
  );

  return (
    <>
      <TopLinks service={videoStreamingServices} />

      {videoStreamingServices.map((subscription) => (
        <Details
