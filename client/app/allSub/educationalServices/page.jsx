...
const page = () => {
  const educationalServices = Object.values(data).filter(
    (entry) => entry.category === "educationalServices"
  );

  return (
    <>
      <TopLinks service={educationalServices} />

      {educationalServices.map((subscription) => (
        <Details
